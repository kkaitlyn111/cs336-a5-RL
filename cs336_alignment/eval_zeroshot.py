...
from cs336_alignment.helper import evaluate_vllm
...
if __name__ == "__main__":
    ...
    #read in dataset
    MATH_val_fpath = "/data/a5-alignment/MATH/validation.jsonl"
    dataset = []
    ...
    evaluate_vllm(vllm_model, reward_fn, prompts, answers, eval_sampling_params, save_fpath)